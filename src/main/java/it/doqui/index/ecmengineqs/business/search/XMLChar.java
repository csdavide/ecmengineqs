...
public class XMLChar {
    ...
    public static boolean isSupplemental(int var0) {
        return var0 >= 65536 && var0 <= 1114111;
    }

    public static int supplemental(char var0, char var1) {
        return (var0 - '\ud800') * 1024 + (var1 - '\udc00') + 65536;
    }

    public static char highSurrogate(int var0) {
        return (char)((var0 - 65536 >> 10) + '\ud800');
    }
    ...
    public static boolean isHighSurrogate(int var0) {
        return 55296 <= var0 && var0 <= 56319;
    }

    public static boolean isLowSurrogate(int var0) {
        return 56320 <= var0 && var0 <= 57343;
    }

    public static boolean isValid(int var0) {
        return var0 < 65536 && (CHARS[var0] & 1) != 0 || 65536 <= var0 && var0 <= 1114111;
    }
    ...
    public static boolean isContent(int var0) {
        return var0 < 65536 && (CHARS[var0] & 32) != 0 || 65536 <= var0 && var0 <= 1114111;
    }

    public static boolean isMarkup(int var0) {
        return var0 == 60 || var0 == 38 || var0 == 37;
    }

    public static boolean isSpace(int var0) {
        return var0 <= 32 && (CHARS[var0] & 2) != 0;
    }

    public static boolean isNameStart(int var0) {
        return var0 < 65536 && (CHARS[var0] & 4) != 0;
    }

    public static boolean isName(int var0) {
        return var0 < 65536 && (CHARS[var0] & 8) != 0;
    }

    public static boolean isNCNameStart(int var0) {
        return var0 < 65536 && (CHARS[var0] & 64) != 0;
    }

    public static boolean isNCName(int var0) {
        return var0 < 65536 && (CHARS[var0] & 128) != 0;
    }

    public static boolean isPubid(int var0) {
        return var0 < 65536 && (CHARS[var0] & 16) != 0;
    }
    ...
    public static boolean isValidNCName(String var0) {
        if (var0.length() == 0) {
            return false;
        } else {
            char var1 = var0.charAt(0);
            if (!isNCNameStart(var1)) {
                return false;
            } else {
                for(int var2 = 1; var2 < var0.length(); ++var2) {
                    var1 = var0.charAt(var2);
    ...
    public static boolean isValidNmtoken(String var0) {
        if (var0.length() == 0) {
            return false;
        } else {
    ...
    public static boolean isValidIANAEncoding(String var0) {
        if (var0 != null) {
            ...
            if (var1 > 0) {
                ...
                if (var2 >= 'A' && var2 <= 'Z' || var2 >= 'a' && var2 <= 'z') {
                    for(int var3 = 1; var3 < var1; ++var3) {
                        ...
                        if ((var2 < 'A' || var2 > 'Z') && (var2 < 'a' || var2 > 'z') && (var2 < '0' || var2 > '9') && var2 != '.' && var2 != '_' && var2 != '-') {
                            return false;
                        }
                    }
    ...
    public static boolean isValidJavaEncoding(String var0) {
        if (var0 != null) {
            int var1 = var0.length();
            if (var1 > 0) {
