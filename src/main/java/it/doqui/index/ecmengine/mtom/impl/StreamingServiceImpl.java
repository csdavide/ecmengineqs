...
import it.doqui.index.ecmengineqs.cxf.impl.ServiceDispatcher;
...
@MTOM
@WebService(
    endpointInterface = "it.doqui.index.ecmengine.mtom.StreamingService",
...
public class StreamingServiceImpl implements StreamingService {
    ...
    @Override
    public String directUploadMethod(Attachment myFile, String usr, String pwd, String repo, String parent, String prefixedName) throws SystemException {
        return serviceDispatcher.getProxy().directUploadMethod(myFile, usr, pwd, repo, parent, prefixedName);
    }
    ...
    @Override
    public ModelMetadata getModelDefinition(ModelDescriptor modelDescriptor, MtomOperationContext context) throws InvalidParameterException, InvalidCredentialsException, NoDataExtractedException, EcmEngineException, RemoteException, EcmEngineTransactionException {
